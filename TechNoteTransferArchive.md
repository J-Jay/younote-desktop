...
As you may have read in this [document](TechNoteGetContent.md), the backup folder contains one folder per device. The name of the folder is the UDID (unique device identifier) of the device. If you own several devices, you see several folders.
